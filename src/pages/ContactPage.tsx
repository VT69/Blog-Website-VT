...
const ContactPage: React.FC = () => {
  ...
  React.useEffect(() => {
    document.title = "Contact Us | Mother's Day Blog";
  }, []);
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <p className="text-gray-600 mb-8">
                Whether you want to share your own mother's day story, suggest a topic, or inquire about partnerships, we're here to listen. Fill out the form, and we'll get back to you as soon as possible.
              </p>
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">info@mothersdayblog.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">123 Blog Street, Suite 400<br />San Francisco, CA 94103</p>
                  </div>
                </div>
                  ...
                  <div className="grid grid-cols-1 gap-y-6">
                    ...
                    <div>
                      <button
                        ...
                        className="w-full px-6 py-3 bg-primary-600 text-white font-medium rounded-lg hover:bg-primary-700 transition-colors disabled:bg-primary-400"
                      >
